...
<div class="l-page">
      ...
      <div class="manager-menu"> <!-- full menu styles -->
        
          <?php print render($page['manager-menu']); ?>
      ...
      <div class="sticky">
          ...
          <div class="row-wrapper"> 
              ...
              <div class="top-nav"> <!-- full menu styles -->
      ...
      <div class="l-main">
        <div class="l-content" role="main">
          ...
          <div class="page-content">
            ...
            <!-- need to fix breadcrumb <?php print $breadcrumb; ?> -->
  ...
  <footer class="l-footer" role="contentinfo">
    <div class="footer-wrap outer-container">
